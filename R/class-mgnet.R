...
mgnet <- setClass(
  ...
  validity=function(object){
    ...
    if(length(object@comm)!=0){
      if(object@comm$vcount!=vcount(obejct@netw)) stop("comm and netw must have the same number of vertices")
    }
